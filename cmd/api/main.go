...
import (
	...
	"github.com/eduartepaiva/greenlight/internal/mailer"
	"github.com/eduartepaiva/greenlight/internal/vcs"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	flag.StringVar(&cfg.db.dns, "db-dns", os.Getenv("GREENLIGHT_DB_DNS"), "PostgreSQL DNS")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", `"Greenlight" <no-reply@greenlight.eduarte.pro>`, "SMTP sender")
